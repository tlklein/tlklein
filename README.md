...
- **[Cloud Resume Challenge](https://github.com/tlklein/portfolio-website)** - A fully serverless, end-to-end web application showcasing cloud-native design and automation. Built on AWS using S3, CloudFront, Lambda, and DynamoDB, deployed via Terraform with CI/CD pipelines in GitHub Actions. 
