...
I am a Cloud Engineer (B.S., Computer Information Systems - Cum Laude) and AWS Certified Cloud Practitioner who architects, deploys, and automates scalable cloud infrastructure and full-stack systems. My specialties include serverless architectures (Lambda, API Gateway, S3, DynamoDB), Infrastructure as Code (Terraform), CI/CD pipelines (GitHub Actions), and security-focused design. I'm experienced with Python, Node.js, Vue.js, database engineering, and network architecture.

[Portfolio](https://www.trinityklein.dev/) • [Linkedin](https://linkedin.com/in/trinity-klein) • [Email](mailto:trinitylklein@outlook.com)

## Featured Projects 

- **[Serverless Portfolio Website](https://github.com/tlklein/portfolio-website)** - A fully serverless, end-to-end web application showcasing cloud-native design and automation. Built on AWS using S3, CloudFront, Lambda, and DynamoDB, deployed via Terraform with GitHub Actions CI/CD pipelines. 
...
- **[Resume Automation Pipeline](https://github.com/tlklein/resume)** - Automated generation of my professional resume using Docker and LaTeX, with ATS-optimized formatting.
...
- **[Multi-Step Cyber Attack Simulation](https://github.com/tlklein/multi-step-cyber-attack)** - An end-to-end penetration testing exercise covering reconnaissance, exploitation, reverse engineering, and privilege escalation.
...
- **Programming & Databases**: Python, JavaScript/TypeScript, Node.js, Bash, SQL, REST APIs, Express.js, Vue.js, React, MongoDB, MySQL, DynamoDB, Go, JavaScript, Serverless Architecture
